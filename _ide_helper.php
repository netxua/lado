 ...
 * Generated for Laravel 5.2.45 on 2017-09-25.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Auth {
         ...
         *
         * @return \Backend\Models\AuthUser|null 
         * @static 
         */ 
         ...
         * @param mixed $id
         * @param bool $remember
         * @return \Backend\Models\AuthUser 
         * @static 
         */ 
...
namespace igaster\laravelTheme\Facades { 
    ...
    class Theme {
         ...
         * @static 
         */ 
        public static function add($theme, $parentName = '')
        {
            return \igaster\laravelTheme\Themes::add($theme, $parentName);
        }
         ...
         * @static 
         */ 
        public static function find($themeName)
        {
            return \igaster\laravelTheme\Themes::find($themeName);
        }
         ...
         * @static 
         */ 
        public static function exists($themeName)
        {
            return \igaster\laravelTheme\Themes::exists($themeName);
        }
        ...
        {
            \igaster\laravelTheme\Themes::set($themeName);
        }
        ...
        {
            return \igaster\laravelTheme\Themes::get();
        }
        ...
        public static function current()
        {
            return \igaster\laravelTheme\Themes::current();
        }
        ...
        {
            return \igaster\laravelTheme\Themes::config($key, $defaultValue);
        }
        ...
        {
            return \igaster\laravelTheme\Themes::configSet($key, $value);
        }
        ...
        {
            return \igaster\laravelTheme\Themes::url($url);
        }
        ...
        {
            return \igaster\laravelTheme\Themes::css($href);
        }
        ...
        {
            return \igaster\laravelTheme\Themes::js($href);
        }
         ...
         * @static 
         */ 
        public static function img($src, $alt = '', $Class = '', $attributes = array())
        {
            return \igaster\laravelTheme\Themes::img($src, $alt, $Class, $attributes);
        }
